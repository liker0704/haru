...
function coordinatorTmuxSession(projectName: string): string {
	return `haru-${sanitizeTmuxName(projectName)}-${COORDINATOR_NAME}`;
}
 ...
 * Used by startCoordinatorSession() and consumed by commands like ha discover.
 */
 ...
 * (e.g., ha discover uses coordinatorName: "discover-coordinator").
 */
