...
export const KNOWN_FIELDS = {
	...
	prTriageConfig: new Set(["minConfidence"]),
	prGhBudgetConfig: new Set(["rpm", "burst", "callTimeoutMs", "maxConcurrent"]),
	prClassifyCiRedConfig: new Set(["flakeThresholdMs", "maxFlakeRetries"]),
} as const;
